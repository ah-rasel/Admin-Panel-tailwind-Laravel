<div class="mt-5">
    <form wire:submit.prevent="Add()" action="" method="POST" autocomplete="off">
         <x-input.label title="Name">
            <x-input.text type="text" wire:model.defer="name" autocomplete="off"/>
            <x-error error-title="name" />
         </x-input.label>
 
         <x-input.label title="Email">
            <x-input.text type="email" wire:model.defer="email" autocomplete="off"/>
            <x-error error-title="email" />
         </x-input.label>
 
         <x-input.label title="Password">
            <x-input.text type="password" wire:model.defer="password" autocomplete="off"/>
